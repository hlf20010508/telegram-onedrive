mime_dict = {
    ...
    "application/x-msdownload": [".bat", ".com", ".dll", ".msi"],
    ...
    "audio/mpeg": [".m2a", ".m3a", ".mp1", ".mp2", ".mp2a", ".mp3", ".mpa", ".mpga"],
    "audio/x-mpegurl": [".m3u"],
    "application/vnd.apple.mpegurl": [".m3u8"],
    "audio/mp4": [".m4a", ".m4b", ".m4r", ".mp4a"],
    "video/vnd.mpegurl": [".m4u", ".mxu"],
    "video/mp4": [".m4v", ".mp4", ".mp4v", ".mpg4"],
    "application/mathematica": [".ma", ".mb", ".nb"],
    "image/x-macpaint": [".mac", ".pnt"],
